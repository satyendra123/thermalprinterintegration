...
printer_name ="POS80 Printer(2)"
hPrinter = win32print.OpenPrinter(printer_name)
job = win32print.StartDocPrinter(hPrinter,1, ("Receipt Job", None, "RAW"))
...
data += b"\x1b\x61\x01"
data += b"\x1b\x45\x01"
data += b"RECEIPT EXAMPLE\n"
data += b"\x1b\x45\x00"
data += b"Thank you for your purchase!\n\n"
data += b"Item: Apples      $10.00\n"
data += b"Item: Bananas     $5.00\n"
data += b"\x1b\x45\x01TOTAL: $15.00\n\x1b\x45\x00"
data += b"\nVisit Again!\n\n\n"
data += b"\x1d\x56\x00"
